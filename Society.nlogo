...
* Houses: Serves as an storage for the spare resources an individual has
...
The common attributes farmers, bandits and soldiers have are:
...
* Load: It represents the quantity of resources a given agent is
...
Houses and City Halls share a common attribute named inventory which
...
* Work: This sub-model is unique for farmers. When it is
...
* Assault: Only bandits are allowed to execute this sub-model.
...
* Seize: Finally, this sub-model is responsible to make
