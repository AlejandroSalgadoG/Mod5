...
them move to their current destination and lose 1 unit of energy. If they have
no energy they will start consuming the resources they are carrying at the
moment to supply their lack of energy.
...
their energy. Any remaining resources will be stored in their resting place for
later use. On the other hand, if they do not have enough resources to do so,
they will execute the switch-occupation submodel.

The switch-occupation submodel is executed in a different way depending on the
agent occupation. In the case of farmers it will dicide if the new occupation is
to became a soldier or a bandit depending on the government support. For both
bandits and soldiers it will cause them to switch occupation into farmers.

In the case an agent is a farmer its destination will cicle through their
assigned farm, city hall and house and when they get to them they will work, pay
taxes or rest respectively.

Work is a subprocess that is unique for farmers. When this occurs they will
extract resources from the farm they are currently in. The amount of resources
extracted will be equal to the max load they are able to carry.

The pay taxes subprocess is also present only in farmers. Farmers will store a
certain amount of the resources they are currently carrying in a city hall. If
they have less than the amount required then they will give up all they have.
The amount of resources farmers must pay in city halls is a parameter selected
at the beginning of the simulation.

The assault submodel is proper of bandits. With this they will chase after the
nearest farmer with non-zero load to steal all of their belongings. In the case
that there is a nearby soldier they will prioritice moving away from them so not
be caught. They will continue to so until either their energy hits zero or they
get to the maximum amount of load they are able to carry, which will cause them
to set their next destination as their home to rest.

Finally, the seize submodel is responsible for soldiers to move to the nearest
bandit and if they get close enought they will make them to switch their
occupation into bandits. All the resources bandits carry when they get caught
are then seized by the soldier. They will chase after bandits until their energy
hits zero or they meet their maximum load, after which they will set their next
destination as their city hall.
